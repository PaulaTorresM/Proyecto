                        ...
                        <div class="card ">
                            <div class="card-header pb-0 p-3">
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-2">Registrar Solicitud</h6>
                                </div>
                            </div>
                            <center>
                                ...
                                <form method="POST" action="AdministrarSolicitudControlador">   
                                    <div id="form">
                                        <table>
                                            <tr>                
                                             Pedido:<br>
                                            <input type="text" name="textPedidoC" ><br>
                                            Fecha de la solicitud:<br> 
                                            <input type="date" name="textFechaSolicitud" ><br>
                                            Descripción:<br> 
                                            <input type="text" name="texDescripcion" ><br>
                                            ...
                                            Técnico:<br> 
                                            <select name="textIdUsuario" >
                                                <option>Seleccione...</option>
                                                <% UsuarioDAO usuDAO = new UsuarioDAO();
                                                    for (UsuarioVO usuVO : usuDAO.listartec()) {

                                                %>
                                                <option value="<%=usuVO.getId_usuario()%>"><%=usuVO.getNom_usu()%></option>
                                                <%}%>
                                            </select><br>
                                            Informe:<br> 
                                            <input type="text" name="textInforme" ><br>
                                            Estado de solicitud<br>
                                            <input type="text" name="textEstadoSolicitud" value="Activo"><br>
                                            </tr>
                                        </table><br>
                                        <button class="btn btn-success">Registrar</button>
                                        <input type="hidden" value="1" name="opcion">
                                        <button class="btn btn-primary"><a href="dashboardAdministrador.jsp" style="color: white; text-decoration: none">Volver</a></button>   
                                    </div>
                                </form>  
                            </center>
                        </div>
