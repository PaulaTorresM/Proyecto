...
<body class="g-sidenav-show   bg-gray-100">
        ...
        <form method="POST" action="Equipo">
            <table>
                <tr>                     
                    ...
                    <input type="text" name="textNombreEquipo" required>
                    
                    <input type="hidden" name="textEstadoEquipo" value="Activo" required><br>
                    Cantidad:<br>
  ...
  <button class="btn btn-primary"><a href="consultarEquipoAdministrador.jsp" style="color: white; text-decoration: none">Volver</a></button>   
