          ...
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">Registrar Usuario Administrador</h6>
              </div>
            </div>
      <section>
          <center>
                  <%                 if (request.getAttribute("mensajeError") != null) {%>
                    ...
                    <table>
                        ...
                        <div class="formulario__grupo" id="grupo__textClave">
                            ...
                            <div class="formulario__grupo-input">
                                <input type="text" class="formulario__input" name="textClave" id="textClave" >
                                <i class="formulario__validacion-estado fas fa-times-circle"></i>
                            </div>
                       ...
                       <div class="formulario__grupo" id="grupo__texTipoDocQ" required="">
                            ...
                            <div class="formulario__grupo-input">
                                <select class="formulario_input" name="texTipoDocQ" id="texTipoDocQ">    
                        ...
                        <div class="formulario__grupo" id="grupo__textNumDoc">
                            <label for="usuario" class="formulario__label">Número de Documento</label>
                            <div class="formulario__grupo-input">
                                <input type="text" class="formulario__input" name="textNumDoc" id="textNumDoc">
                                <i class="formulario__validacion-estado fas fa-times-circle"></i>
                            </div>
                            <p class="formulario__input-error">Debe tener 5 a 10 dígitos y solo puede contener numeros.</p>
                        </div>
                        ...
                        <div class="formulario__grupo" id="grupo__textCorreo">
                            ...
                            <div class="formulario__grupo-input">
                                <input type="text" class="formulario__input" name="textCorreo" id="textCorreo">
                                <i class="formulario__validacion-estado fas fa-times-circle"></i>
                            </div>
                   ...
                   <button class="btn btn-primary"><a href="consultarUsuarioAdministrador.jsp" style="color: white; text-decoration: none">Volver</a></button>   
